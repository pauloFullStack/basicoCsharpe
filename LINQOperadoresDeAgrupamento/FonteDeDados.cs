...
namespace LINQOperadoresDeAgrupamento
{
    internal class FonteDeDados
    {
        ...
        public static List<Aluno> GetAlunos()
        {
            ...
            {
                new Aluno(){Nome = "Maria", Idade = 36, Nota = 7, Cursos = new List<string> { "C++", "MongoDB", "Node" } },
                new Aluno(){Nome = "Manoel", Idade = 33, Nota = 6, Cursos = new List<string> {"TypeScript", "React", "Node"}},
                new Aluno(){Nome = "Amanda", Idade = 21, Nota = 5, Cursos = new List<string> {"C++", "MongoDB", "Node"}},
        ...
        public static List<Aluno> GetAlunosA()
        {
            List<Aluno> alunos = new List<Aluno>()
            {
                new Aluno(){Nome = "Maria", Idade = 36, Nota = 7, Curso = "Fisica" },
                new Aluno(){Nome = "Manoel", Idade = 36, Nota = 6, Curso = "Quimica"},
                new Aluno(){Nome = "Amanda", Idade = 36, Nota = 5, Curso = "Engenharia"},
                new Aluno(){Nome = "Carlos", Idade = 17, Nota = 9, Curso = "Moda"},
                new Aluno(){Nome = "Jaime", Idade = 17, Nota = 9, Curso = "Moda"},
                new Aluno(){Nome = "Debora", Idade = 17, Nota = 4, Curso = "Fisica"},
                new Aluno(){Nome = "Alicia", Idade = 17, Nota = 4, Curso = "Engenharia"},
                new Aluno(){Nome = "Sandra", Idade = 50, Nota = 4, Curso = "Quimica"},
                new Aluno(){Nome = "Sandra", Idade = 36, Nota = 4, Curso = "Quimica"},
                new Aluno(){Nome = "Sandra", Idade = 50, Nota = 4, Curso = "Quimica"},
                new Aluno(){Nome = "Danusa", Idade = 50, Nota = 4, Curso = "Engenharia"},
                new Aluno(){Nome = "Jorge", Idade = 50, Nota = 4, Curso = "Quimica"},
            };
